...
class AutoModel(nn.Module):
    ...
    def load_from_folder(cls, dir_path: str):
        ...
        elif model_name == "BetaVAEmissConfig":
            from ..beta_vae2 import BetaVAEmiss

            model = BetaVAEmiss.load_from_folder(dir_path=dir_path)

        elif model_name == "BetaVAEgpConfig":
            from ..beta_vae_gp import BetaVAEgp

            model = BetaVAEgp.load_from_folder(dir_path=dir_path)

        elif model_name == "BetaVAEgpIndConfig":
            from ..beta_vae_gp import BetaVAEgpInd

            model = BetaVAEgpInd.load_from_folder(dir_path=dir_path)
        elif model_name == "BetaVAEgpCondIndConfig":
            from ..beta_vae_gp import BetaVAEgpCondInd

            model = BetaVAEgpCondInd.load_from_folder(dir_path=dir_path)

        elif model_name == "BetaVAEgpPriorConfig":
            from ..beta_vae_gp import BetaVAEgpPrior

            model = BetaVAEgpPrior.load_from_folder(dir_path=dir_path)

        elif model_name == "BetaVAEgpPostConfig":
            from ..beta_vae_gp import BetaVAEgpPost

            model = BetaVAEgpPost.load_from_folder(dir_path=dir_path)
    ...
    def load_from_hf_hub(
        ...
        if model_name == "Adversarial_AE_Config":
            ...
            model = BetaVAEmiss.load_from_hf_hub(
                hf_hub_path=hf_hub_path, allow_pickle=allow_pickle
            )
