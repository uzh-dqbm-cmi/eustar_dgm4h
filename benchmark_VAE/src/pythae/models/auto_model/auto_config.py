...
class AutoConfig(BaseConfig):
    ...
    def from_json_file(cls, json_path):
        ...
        if config_name == "BaseAEConfig":
        ...
        elif config_name == "BetaVAEmissConfig":
            from ..beta_vae2 import BetaVAEmissConfig

            model_config = BetaVAEmissConfig.from_json_file(json_path)

        elif config_name == "BetaVAEgpConfig":
            from ..beta_vae_gp import BetaVAEgpConfig

            model_config = BetaVAEgpConfig.from_json_file(json_path)

        elif config_name == "BetaVAEgpIndConfig":
            from ..beta_vae_gp import BetaVAEgpIndConfig

            model_config = BetaVAEgpIndConfig.from_json_file(json_path)
            ...
            model_config = BetaVAEgpPriorConfig.from_json_file(json_path)

        elif config_name == "BetaVAEgpPostConfig":
            from ..beta_vae_gp import BetaVAEgpPostConfig

            model_config = BetaVAEgpPostConfig.from_json_file(json_path)
