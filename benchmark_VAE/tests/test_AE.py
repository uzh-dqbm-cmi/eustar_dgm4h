...
class Test_AE_Training:
    ...
    def test_ae_train_step(self, ae, train_dataset, training_configs, optimizers):
        trainer = BaseTrainer(
            model=ae,
    ...
    def test_ae_eval_step(self, ae, train_dataset, training_configs, optimizers):
        trainer = BaseTrainer(
            model=ae,
            train_dataset=train_dataset,
    ...
    def test_ae_predict_step(self, ae, train_dataset, training_configs, optimizers):
        trainer = BaseTrainer(
            model=ae,
            train_dataset=train_dataset,
            eval_dataset=train_dataset,
