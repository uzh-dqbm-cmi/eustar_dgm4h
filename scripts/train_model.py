...
sys.path.append("/cluster/work/medinfmk/EUSTAR2/code_ct/benchmark_VAE/src/pythae/models/beta_vae_gp")
from pythae.models.beta_vae_gp.utils import load_missing_data_train_test, get_classifier_config
from pythae.trainers import BaseTrainerConfig
from pythae.pipelines.training import TrainingPipeline
from pythae.models.beta_vae_gp.classifier_config import EncoderDecoderConfig, PriorLatentConfig, DecoderConfig
from pythae.models import BetaVAEgpCondInd
from pythae.models import BetaVAEgpCondIndConfig
from pythae.models.beta_vae_gp.encoder_decoder import LSTM_Encoder, LSTM_Retrodiction_Encoder, LSTM_Retrodiction_Decoder, Guidance_Classifier, Indep_MLP_Decoder
from pythae.models.beta_vae_gp.prior_latent import PriorLatent
from pythae.models.beta_vae_gp.plots import *
import random
import numpy as np

if __name__ == "__main__":
    data_path = '/cluster/work/medinfmk/EUSTAR2/data/processed/ct/'
    figure_path = "/cluster/work/medinfmk/EUSTAR2/plots_ct/"
    #name = "_reduced"
    name = "_medium"
    #name = "_allcont"
    ...
    data_train, data_test, varNames, varSplits, xyt0, xyt1 = load_missing_data_train_test(data_path, name=name)
    ...
    kinds_x0 = [ var.kind for var in (body.variables+ body.labels) for nx in names_x0 if var.name==nx ]
    kinds_y0 = [ var.kind for var in (body.variables+ body.labels) for nx in names_y0 if var.name==nx ]
    ...
    prior_config = PriorLatentConfig.from_dict({"input_dim": 1 + static_size, 
                                                "latent_dim": latent_dim, "hidden_dims": [50], "device": device, "dropout": 0.3})
